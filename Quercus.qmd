...
replicate_run <- function(n_bootstrap, sdm_data_pts, species_name, point_count, predictors, modelmethod) { #do this for however many times you want to bootstrap
...
bootstrap_sdm <- function(
  ...
  replicate_run(n_bootstrap, sdm_data_pts, species_name, point_count, predictors, modelmethod)

library(furrr)
plan(multisession, workers = 20)


future_map(1:n_bootstrap, .f = replicate_run(n_bootstrap, sdm_data_pts, species_name, point_count, predictors, modelmethod), .progress = TRUE)
